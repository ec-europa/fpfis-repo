...
# https://pecl.php.net/package-info.php?package=gnupg&version=1.4.0
...
%description
%{pecl_name} is a native php extension that allows you to interact with gnupg.  
...
%changelog
* Wed May 17 2017 Gregory Boddin <gregory@siwhine.net> - 1.4.0-1
- Ported pecl gnupg from imagick original spec file
